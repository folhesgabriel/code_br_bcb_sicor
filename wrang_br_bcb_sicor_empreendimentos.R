...
##ler caminho do arquiivo de input
arquivo_bruto_empreendimento <- list.files("C:/Users/gabri/OneDrive/vida_profissional/Projetos/amazonDB/sicor_bd/Template Dados/input",
                                    full.names = T,
...
#criar diretorio
dir.create("C:/Users/gabri/OneDrive/vida_profissional/Projetos/amazonDB/sicor_bd/Template Dados/output/empreendimento/",
                  showWarnings = FALSE,
                  recursive = T)

#salvar arquivo tratado
write.table(empreendimentos,
            "C:/Users/gabri/OneDrive/vida_profissional/Projetos/amazonDB/sicor_bd/Template Dados/output/empreendimento/empreendimento.csv",
            na = '',
            quote = FALSE,
            row.names = FALSE,
            sep = ",")
